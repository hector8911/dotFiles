...
" Monokai based on tanvirtin/monokai.nvim
...
local monokai = {
    ...
    alternate_blue = "#529BF9",
    alternate_purple = "#B77EE0",
    alternate_cyan = "#B3F5FC",
    alternate_white = "#FFFFFF",
    alternate_grey = '#88846f',
    none = "NONE"
}
...
function monokai.load_plugin_syntax()
    local plugin_syntax = {
        ...
        TSParameter = {
          fg = monokai.alternate_yellow
        },
        TSParameterReference = {
          fg = monokai.orange
        },
        TSConditional = {
          fg = monokai.alternate_blue
        },
        TSKeywordFunction = {
            fg = monokai.alternate_blue
        },
